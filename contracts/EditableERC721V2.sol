...
/// @notice ERC-721 collection with full ERC-4906 metadata update events for marketplace sync.
/// @dev New launchpad deployments use this contract; legacy collections keep EditableERC721.
contract EditableERC721V2 is
    ERC721URIStorage,
    ERC2981,
    Ownable2Step,
    ReentrancyGuard,
