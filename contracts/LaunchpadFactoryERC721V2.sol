...
import {EditableERC721V2} from "./EditableERC721V2.sol";
...
/// @notice Deploys EditableERC721V2 collections (full ERC-4906). Kept separate from ERC-1155 factory for bytecode size.
contract LaunchpadFactoryERC721V2 is Ownable2Step {
    ...
    function deployCollectionERC721(
        ...
        emit CollectionDeployedV2(msg.sender, collection, name, symbol, 0, maxSupply);
    }
}
