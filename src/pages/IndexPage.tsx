    ...
    <div className="space-y-10">
      <div className="relative overflow-hidden rounded-2xl border border-slate-800/80 bg-gradient-to-br from-slate-900/80 via-slate-950 to-slate-950 px-6 py-8 sm:px-8 sm:py-10">
        ...
        <div className="relative mx-auto max-w-3xl text-center sm:text-left">
          <p className="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-300/80">Electroneum mainnet</p>
          <h1 className="mt-3 bg-gradient-to-r from-white via-slate-100 to-slate-300 bg-clip-text text-3xl font-bold tracking-tight text-transparent sm:text-4xl">
            Mint NFTs
          </h1>
